/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 51ca207e64a4d5a2507c4de2b1fac1a5)
// Runtime types generated with workerd@1.20251217.0 2025-12-17 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./server");
		durableNamespaces: "Chat" | "QuantAgent";
	}
	interface Env {
		Chat: DurableObjectNamespace<import("./server").Chat>;
		QuantAgent: DurableObjectNamespace<import("./server").QuantAgent>;
		MARKET_MEMORY: VectorizeIndex;
		AI: Ai;
	}
}
